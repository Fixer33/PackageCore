...
namespace Core.Editor.Utilities
{
    ...
    public class TypeReferenceDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            List<Type> possibleTypes = _allTypes
                .Where(t => typeReference.Editor_GetTypeBase().IsAssignableFrom(t) && !t.IsAbstract)
                .ToList();
            possibleTypes.Insert(0, null); // Add 'No type' option
            ...
            int currentIndex = possibleTypes
            ...
            int newIndex = EditorGUI.Popup(
                ...
                currentIndex,
                possibleTypes.Select(t => t != null ? t.FullName : "No type").ToArray()
            );

            // Apply the selected type name
            typeNameProp.stringValue = newIndex > 0 && newIndex < possibleTypes.Count
                ? possibleTypes[newIndex].FullName
                : "No type";
